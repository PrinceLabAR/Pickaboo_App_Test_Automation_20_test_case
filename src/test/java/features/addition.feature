Feature: Testing Pickaboo
 ...
 Background:
  ...
  @MobileTest
    Scenario: Check The Mobile Accessories
  ...
  @MobileTest
    Scenario: Check Life Style Categories
  ...
  @Mobiletest
    Scenario: Explore Slider
        ...
        Then  Then Process to check out
  @MobileTest
    Scenario: Check The Electronics and appliance
        ...
        Then  Then Process to check out
  @MobileTest
  Scenario: Check The Refrigerator items is stocked
    Given Check The Electronics and appliance is available
    When  Click The Electronics and appliance button
    Then  Click The Electronics and appliance is Display
  ...
  Scenario: Explore Gaming Phone
    ...
    Then  Then Process to check out
  @MobileTest
  Scenario: Explore Mobile Accessories and buy a data cable
    Given Check the Mobile Accessories is available
    When  Click the Mobile Accessories button
    Then  Click the Mobile Button is Display
  ...
  @MobileTest
  Scenario: Check The Washing Machine items is Place to order
    Given Check The Electronics and appliance is available
    When  Click The Electronics and appliance button
    Then  Click The Electronics and appliance is Display
    ...
    Then  Then Press to check out
  @MobileTest
  Scenario: Buy Haier Washing Machine
    Given Check The Electronics and appliance is available
    When  Click The Electronics and appliance button
    Then  Click The Electronics and appliance is Display
    Then  Select Washing Machine categories
    ...
    Then  Then Press to check out
  @MobileTest
  Scenario: Buy HWM Washing Machine
    Given Check The Electronics and appliance is available
    When  Click The Electronics and appliance button
    Then  Click The Electronics and appliance is Display
    Then  Select Washing Machine categories
    ...
    Then  Then Press to check out
  @MobileTest
  Scenario: Check computer category and buy Honor
    Given Check Slider button is available
    When  Click on the Slider Button
    Then  Check the Slider is Display
    ...
    Then  Then Process to check out
  @MobileTest
  Scenario: Check computer category and buy Pen Drive
    Given Check Slider button is available
    When  Click on the Slider Button
    Then  Check the Slider is Display
